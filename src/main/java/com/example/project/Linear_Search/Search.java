...
public class Search {
    ...
    public static int linearSearchLast(int[] elements, int target) {
        // traversing IN REVERSE allows you to find the LAST index something is found
        // while still early returning!
    ...
    public static boolean linearSearchFound(int[] elements, int target) {
        // don't need an index, so can use the preferred enhanced for loop
